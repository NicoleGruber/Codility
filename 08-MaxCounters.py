...
que, dado um número inteiro N e uma matriz não vazia A que consiste em M números inteiros,
retorna uma sequência de números inteiros representando os valores dos contadores.
